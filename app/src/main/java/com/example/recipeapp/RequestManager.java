...
public class RequestManager {
    ...
    public  void getSimilarRecipes(SimilarRecipesListener listener,int id){
        ...
        Call <List<SimilarRecipeResponse>> call = callSimilarRecipes.callSimilarRecipeResponse(id,"4",context.getString(R.string.api_key));
    ...
    private void getInstructions(InstructionsListener listener, int id){
    ...
    private interface CallSimilarRecipes{
        ...
        Call<List<SimilarRecipeResponse>> callSimilarRecipeResponse(
                @Path("id") int id,
                @Query("number") String number,
                @Query("apiKey") String apiKey
        );
