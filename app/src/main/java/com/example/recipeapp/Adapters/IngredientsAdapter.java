...
public class IngredientsAdapter extends  RecyclerView.Adapter<IngredientsViewHolder>{
   ...
   List<ExtendedIngredient> list;
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        holder.texteView_ingredients_quantity.setText(list.get(position).original);
        holder.texteView_ingredients_quantity.setSelected(true);
...
class IngredientsViewHolder extends RecyclerView.ViewHolder{
    ...
    TextView texteView_ingredients_quantity,textView_ingredients_name;
    ImageView imageView_ingredients;

    public IngredientsViewHolder(@NonNull View itemView) {
        super(itemView);
        texteView_ingredients_quantity = itemView.findViewById(R.id.texteView_ingredients_quantity);
